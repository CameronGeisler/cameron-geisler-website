---
title: "Calculator Guide for Students (How to Buy a Calculator)"
date: 2025-06-04
slug: "calculator-guide-for-students-how-to-buy-a-calculator"
excerpt: "So many students are underusing calculators in their math classes"
---

So many students are underusing calculators in their math classes. In particular:

- Using an overly basic and non-user-friendly calculator, and,

- Not learning how to use their calculator, and what their calculator can do
...
The 3 major categories your course can have allow:

- **Any calculator **(including online): most powerful, best for online or self-paced courses, or take-home assignments

- **Graphing calculators**: typically used for standardized tests (like the AP Calculus exam)
...
**[Desmos](https://www.desmos.com/calculator) is the best all-around graphing calculator for most students.**
...
For more heavy-duty math, try [Wolfram Alpha](https://www.wolframalpha.com/).

There are also many tools for specific computations. For example, for calculus, there is [Derivative Calculator](https://www.derivative-calculator.net/) and [Integral Calculator](https://www.integral-calculator.com/).
...
**My recommended scientific calculator: [Casio fx-991ES PLUS C 2nd edition](https://www.amazon.ca/Casio-FX-991ESPLUS2-Authenticity-verification-FX-991ESPLSC2-S-CT/dp/B086548F31)**

This calculator is an amazing balance of being very useful, while also being very user-friendly.

It is seriously a cheat code, and you can buy it on Amazon for $25.
...
- Can simplify radicals (e.g. typing in sqrt(12) gives 2*sqrt(3))

- Can rationalize denominators (e.g. typing in 1/sqrt(2) gives sqrt(2)/2)

- Can evaluate trigonometric ratios exactly (e.g. sin(60) = sqrt(3)/2 as opposed to 0.866…)

- Can evaluate logarithms of any base (you can type in e.g. log2(7))

- Can do prime factorization of a number

- Also has some more advanced math abilities, like:

Solving quadratic equations (exactly), finding the vertex of a parabola

- Solving cubic equations

- Solving systems of linear equations

- Numerical equations solving

- Numerical differentiation and integration

Note: The [Casio fx-991ES Plus 2nd edition](https://www.amazon.ca/Casio-FX-991ES-Plus-2nd-Scientific-Calculator/dp/B0846D5CBP) (without the "C") is very similar to the C version, except is missing a few features (like finding the vertex of a parabola, or do prime factorization). Ideally, you should get the C version, however for most purposes they are equivalent.

Note: This calculator is functionally equivalent to the [fx-115ES PLUS 2nd Edition](https://www.amazon.ca/Casio-fx-115ESPLS2-Advanced-Scientific-Calculator/dp/B086Z79HXS). The only difference is the 115ES was released for the US market, whereas the C version is for Canada ("C" for Canada).

Note: If you just need a virtual version, you can get an emulator of this calculator for PC for free for a 90-day trial. Go to the [Casio Education website](https://edu.casio.com/softwarelicense/index.php), choose your operating system (Windows or Mac), find the download link for the fx-991ES Plus C 2nd edition, and install it on your computer.

**Runner up: [Casio fx-300ES PLUS 2nd edition](https://www.amazon.ca/Casio-fx-300ESPLS2-Scientific-Calculator-Textbook/dp/B086Z71GQ3)**
...
**Graphing calculators are basically obsolete, with online graphing tools like Desmos as mentioned above.**
...
**For the AP Calculus exam, Desmos is allowed!** This means that if you are solely taking that exam, you don't need to buy a graphing calculator! You can use a calculator which is more powerful, easier to use, and free.

However, if you need a calculator, here are the 2 best options:

**[TI-Nspire CX II CAS](https://www.amazon.ca/Texas-Instruments-TI-Nspire-Graphing-Calculator/dp/B07RL7HM5V). This is the most powerful graphing calculator.**

It has computer-algebra software (CAS) abilities, so it can calculate with algebraic expressions, like simplifying, factoring, and expanding, and solving equations exactly. All of these are similar to what the free online calculators can do, but this is a calculator that is (sometimes) allowed for classroom tests.

Most notably, as of 2025, it is allowed on the AP Calculus exam (in particular the graphing calculator section).

However, there are some downsides. In particular, it is less user-friendly, partly because it has so many features that the buttons and functions can be overwhelming.

Also, it is the most expensive option, being around $200-250 new. You can find it used for $50-150 on an online marketplace like Facebook Marketplace.
...
**[TI-84 Plus CE](https://www.amazon.ca/Texas-Instruments-TI-84-Graphing-Calculator/dp/B00TFYYWQA) is the best recommendation, if CAS calculators are not allowed**. It is the most popular graphing calculator today, especially for AP Calculus.
